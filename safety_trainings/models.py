...
class SafetyTraining(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if self.category == 'ELECTRICAL':
            self.next_training_date = self.training_date + relativedelta(years=1)
        ...
        # Первичный/повторный по охране труда и пожарной безопасности - 1 раз в 6 месяцев
            ...
            self.next_training_date = self.training_date + relativedelta(months=6)

        # Для вводных, внеплановых и целевых следующий инструктаж не назначается автоматически
